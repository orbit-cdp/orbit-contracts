...
import type { i128 } from '@stellar/stellar-sdk/lib/contract_client';
...
export declare const networks: {
    readonly standalone: {
        ...
        readonly contractId: "CBHNYJQ3GDJCNYKTPN3DTPYKZF4ZMMSEQY2IJFE4O5IMJ6GXYLN5HC3T";
    };
};
/**
...
export interface Client {
     ...
     */
    initialize: ({ admin, token, blend_pool }: {
        admin: string;
        token: string;
        blend_pool: string;
    }, options?: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        increase_supply: (json: string) => AssembledTransaction<null>;
        decrease_supply: (json: string) => AssembledTransaction<null>;
        get_token_address: (json: string) => AssembledTransaction<string>;
        get_blend_address: (json: string) => AssembledTransaction<string>;
    };
}
