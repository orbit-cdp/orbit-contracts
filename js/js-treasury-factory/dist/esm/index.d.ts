...
export declare const networks: {
    readonly standalone: {
        ...
        readonly contractId: "CB52HS33TBPKPAXW6Z52DZKUGV4GVCPA4UPWFLPHUQWFPL47IONV6UG4";
    };
};
export type TreasuryFactoryDataKey = {
    tag: "Contracts";
...
export interface Client {
     ...
     */
    initialize: ({ admin, treasury_init_meta }: {
        admin: string;
        treasury_init_meta: TreasuryInitMeta;
    }, options?: {
        /**
     ...
     */
    deploy: ({ salt, token_address, blend_pool }: {
        salt: Buffer;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        is_treasury: (json: string) => AssembledTransaction<boolean>;
    };
}
